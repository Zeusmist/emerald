...
const PaymentMethod = ({ id, token, getCards, cards }) => {
    ...
    return (
      <div className="dashboard__card--cardItem__holder" key={i}>
        <div className="dashboard__card--bankItem ">
          <span className="main">Card {i + 1}</span>
          <br />
          <br />
          <small>Card Number: {card.cardNumber}</small>
          <br />
          <br />
        </div>
      </div>
  ...
  return (
    <div className="dashboard__holder">
      ...
      <div
        className="dashboard__card__add-button"
        ...
        <Modal.Body className="modalBody">
          <div>
            ...
            >
              <button
                onClick={AddBank}
                style={{ padding: 10, background: "#FFFFFF", border: "none" }}
              >
                Add Bank
              </button>
            </div>
