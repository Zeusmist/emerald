...
console.log(otpData);
  ...
  await fetch('https://desolate-anchorage-42140.herokuapp.com/api/v1/users/verifyAccount', {
            method: 'PATCH',
            headers: {
    ...
    <div className="d-flex justify-content-center align-items-center container">
      <div className="card py-5 px-3">
        ...
        <div className="d-flex flex-row mt-5">
          ...
          <input type="number" className="verifyInput" onChange={(e)=>{setOtp(e.target.value)}}/> 
